...
public class Indexer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] args1 = new String[2];
         args1[0]="C:\\Users\\dshaikh\\Desktop\\Fashion Images\\mensshoes";
        
        boolean passed = false;
        if (args1.length > 0) {
            File f = new File(args1[0]);
            System.out.println("Indexing images in " + args1[0]);
        ...
        ArrayList<String> images = FileUtils.getAllImages(new File(args1[0]), true);

        System.out.println("Images to index :" + images.size());
        ...
        builder.addBuilder(new GenericDocumentBuilder(PHOG.class));
        builder.addBuilder(new GenericDocumentBuilder(JCD.class));
        builder.addBuilder(new GenericDocumentBuilder(EdgeHistogram.class));
        builder.addBuilder(new GenericDocumentBuilder(ColorLayout.class));
        builder.addBuilder(new GenericDocumentBuilder(Tamura.class));
